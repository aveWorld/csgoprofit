...
const trade = () => {
    ...
    <div className="container-blog">
        ...
        <main className="container-wrapper">
            ...
            <img src="buy_order.jpg" alt="but order button" className="buy-order"/>
            ...
            <img src="redline_stickers.jpg" alt="redline with stikcers" className="redline_stickers"/>
            ...
            <img src="floats.jpg" alt="floats" className="floats"/>

...
const riskyTradeups = () => (
  <article className="container-blog">
    <Head>
      <title>Three risky CS:GO trade ups</title>
      <meta name="description" content="three risky and high reward CS:GO trade ups." />
    </Head>
    <Navbar />
    <div className="container-wrapper">
      ...
      <p className="outcomes">Outcomes</p>
      <div className="skin-cards">
        <div className="skin-card">
          ...
          <div className="skin-card--footer failure">
            <span className="card-profit">-2.5$</span>
            <span className="card-percantage">30%</span>
          </div>
        </div>
        <div className="skin-card">
          <div className="skin-card--header">
          ...
          <div className="skin-card--main">
            ...
            <p>Battle-Scarred(BS)</p>
            <p>0.23$</p>
          </div>
          <div className="skin-card--footer failure">
            <span className="card-profit">-2.68$</span>
            <span className="card-percantage">30%</span>
          </div>
        </div>
        <div className="skin-card">
          ...
          <div className="skin-card--footer failure">
            <span className="card-profit">-2.28$</span>
            <span className="card-percantage">30%</span>
          </div>
        </div>
      </div>
      ...
      <div className="skin-cards">
        <div className="skin-card">
          ...
          <div className="skin-card--footer success">
            <span className="card-profit">+21.58$</span>
            <span className="card-percantage">3.3%</span>
          </div>
        </div>
        <div className="skin-card">
          <div className="skin-card--header">
          ...
          <div className="skin-card--footer success">
            <span className="card-profit">+18.08$</span>
            <span className="card-percantage">3.3%</span>
          </div>
        </div>
        <div className="skin-card">
          ...
          <div className="skin-card--footer success">
            <span className="card-profit">+8.44$</span>
            <span className="card-percantage">3.3%</span>
          </div>
        </div>
      </div>
      ...
      <div className="skin-cards">
        <div className="skin-card">
          ...
          <div className="skin-card--footer success">
            <span className="card-profit">+32.23$</span>
            <span className="card-percantage">4.76%</span>
          </div>
        </div>
        <div className="skin-card">
          <div className="skin-card--header">
          ...
          <div className="skin-card--footer success">
            <span className="card-profit">+22.8$</span>
            <span className="card-percantage">4.76%</span>
          </div>
        </div>
        <div className="skin-card">
          ...
          <div className="skin-card--footer success">
            <span className="card-profit">+32.69$</span>
            <span className="card-percantage">4.76%</span>
          </div>
        </div>
        <div className="skin-card">
          ...
          <div className="skin-card--footer success">
            <span className="card-profit">+19.4$</span>
            <span className="card-percantage">4.76%</span>
          </div>
        </div>
      </div>
      <div className="skin-cards">
        <div className="skin-card">
          ...
          <div className="skin-card--footer failure">
            <span className="card-profit">-6.64$</span>
            <span className="card-percantage">38.1%</span>
          </div>
        </div>
        ...
        <div className="skin-card">
          ...
          <div className="skin-card--footer failure">
            <span className="card-profit">-6.67$</span>
            <span className="card-percantage">38.1%</span>
          </div>
        </div>
        <div className="skin-card">
          ...
          <div className="skin-card--footer failure">
            <span className="card-profit">-4.3$</span>
            <span className="card-percantage">4.76%</span>
          </div>
        </div>
      </div>
      ...
      <div className="skin-cards">
        <div className="skin-card">
          ...
          <div className="skin-card--footer failure">
            <span className="card-profit">-12$</span>
            <span className="card-percantage">75%</span>
          </div>
        </div>
        <div className="skin-card">
          <div className="skin-card--header">
          ...
          <div className="skin-card--footer success">
            <span className="card-profit">+41.19$</span>
            <span className="card-percantage">8.33%</span>
          </div>
        </div>
        <div className="skin-card">
          <div className="skin-card--header">
          ...
          <div className="skin-card--footer success">
            <span className="card-profit">+40.29$</span>
            <span className="card-percantage">8.33%</span>
          </div>
        </div>
        <div className="skin-card">
          ...
          <div className="skin-card--footer success">
            <span className="card-profit">+54.91$</span>
            <span className="card-percantage">8.33%</span>
          </div>
        </div>
      </div>

...
const FractureCase = () => (
  <article className="container-blog">
    <Head>
      ...
      <meta
        name="description"
        content="Lookout of new Fracture Case and explaining price droping of shattered web"
      />
    </Head>
    <Navbar />
    <div className="container-wrapper">
      ...
      <p>
        One reason why shattered web case was so popular and expensive is that it has 3 unique
        knives that you can knock out only in it
      </p>
      ...
      <p>
        Definitely not, shattered web case is unique, that's mean the amount of this case will only
        decreasaing.
      </p>
      ...
      <img
        src="/ak47_legionOfAnubis.webp"
        alt="AK 47 | Legion Of Anubis"
      ...
      <p>
        I think that the fate of the Fracture case is the same as that of the Prisma 2 case,
        drawdown in price by at least 5 times in the near future
      </p>
    </div>
    <Footer />
  </article>
